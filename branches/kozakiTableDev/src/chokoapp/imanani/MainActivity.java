...
public class MainActivity extends Activity {
    ...
    public void onClickStartButton(View view) {
        long start_miliseconds = timeKeeper.beginWork();
        ContentValues startValue = new ContentValues();
        startValue.put("start", start_miliseconds / 1000);
        db.insert(Work.TABLE_NAME, null, startValue);
    }

    public void onClickFinishButton(View view) {
        long end_miliseconds = timeKeeper.endWork();
        Work.finished(db, end_miliseconds);
    }
}
